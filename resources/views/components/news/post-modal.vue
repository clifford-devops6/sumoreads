                        ...
                        <div v-show="index===slideActive" v-for="(post, index) in posts" :key="post.id" class="bg-black text-white">
                            ...
                            <div class="p-3">
                                ...
                                <div class="my-3 flex justify-end gap-2">
                                    ...
                                    <Link v-show="auth" preserve-scroll class="btn-primary" title="Share articles">Read later<span class="ml-2"><i class="fa-light fa-bookmark"></i></span></Link>
                                    <Link v-show="auth" preserve-scroll class="btn-primary" title="Share articles">Share<span class="ml-2"><i class="fa-light fa-share-nodes"></i></span></Link>
                                </div>
                            </div>
                        </div>
