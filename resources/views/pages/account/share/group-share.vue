<template>
    ...
    <reader>
        <template #sidebar>
            <share-menu :groups="groups.data" :users="users.data" :page="route('group.share',user_id)"></share-menu>
        </template>
        ...
        <div>
            <second-post-modal v-if="postModal" :show="postModal" @close="postModal=false" :posts="shareds.data" :currentPost="currentPost"></second-post-modal>
        </div>
    </reader>
</template>
