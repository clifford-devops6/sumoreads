<template layout="auth">
    ...
    <div class="flex place-content-center h-screen">
        <div class="bg-white shadow-xl rounded-xl self-center md:w-1/2 p-4">
            ...
            <div class="text-center font-bold text-xl mt-5">Select {{account.data.type.name}} Package</div>
                ...
                <div class="px-10">
                    <div class="border rounded-lg p-3 text-center shadow-md py-10">
                       <p> A minimum of {{min_slots}} members</p>
                        <p class="mt-3">(1 Primary user plus {{1-min_slots}} {{account.data.type.name}} users)</p>
                    <div class="flex justify-end mt-4">
                        <p class="font-bold"><span class="text-primary-100 text-lg">{{account.data.type.price*min_slots}}</span> per month</p>
                    </div>
                    </div>
                    <div class="mt-10 text-center">
                        <h6 class="text-lg">Do you have more than {{min_slots}} members?</h6>
                        <div class="mt-3">
                            <form @submit.prevent="form.post(route('account-setup.store'))" id="package-form">
                            ...
                            <p class="my-5">Extra members will be charged at a rate of USD {{account.data.type.price}} each per month</p>
                    ...
                    <div class="my-10">
                        ...
                        <div class="my-5 flex justify-between">
                           <h6 class="font-bold">Total</h6>
                            <h6 class="font-bold text-primary-100">USD {{form.members*account.data.type.price}}</h6>
                        </div>
