                    ...
                    <div class="fixed w-64">
                        ...
                        <div class="mt-8 mx-4">
                            ...
                            <ul>
                                ...
                                <li>
                                    <Link :href="route('advertisement.index')">
                                        <div class="w-full rounded-md px-3 py-1">
                                            <p class="font-semibold hover:text-primary-200 text-sm text-gray-800"><span class="mr-2 text-primary-200"><i class="far fa-angle-right"></i></span>Advertisement</p>
                                        </div>
                                    </Link>
                                </li>
